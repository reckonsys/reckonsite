    ...
    <section className="ceo-note">
      ...
      <div className="ceo-note-content">
        <p>
          ...
          solution that may soon require an overhaul. This is where we strive to
          do the things right the first time around without compromising on
    ...
    <section className="article-section">
      <div className="container">
        ...
        <p className="description">
          ...
          our work and have fun learning new things to make us more relevant in
      ...
      <div className="col">
        <div className="team-list-item">
          ...
          <div className="overlay">
            ...
            <p className="role">Hardcore Rahmaniac , Designs Occassionally.</p>
            <a
