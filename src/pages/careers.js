    ...
    <section className="job-openings">
      <div className="container">
        ...
        <div className="jobs-wrap d-flex">
          {staticDatas.jobOpenings.map((job, idx) => {
            return (
    ...
    <section className="whats-in-for-you">
      <div className="container">
        ...
        <p className="desc m-b-50">
          At Reckonsys, we try to KISS (Keep it Simple and Straightforward), and
          believe that this can only be done by defying convention and trying to
          develop a disruptive approach to things. For us, learning from
          mistakes is common as we want our team to try out new things and push
          themselves out of their comfort zones. We value people for who they
          are and believe that everyone is special in their own unique way.We
          help in bringing out the best in employees, by giving them the best
          opportunities and challenges required for growth.
        </p>
        <div className="key-points-wrap d-flex">
          ...
          <div className="key-points">
            ...
            <p>
              ...
              often priceless. We encourage our team members to attain financial
              freedom by providing paid membership of a online mutual fund
              platform.
            </p>
          </div>
          <div className="key-points">
            ...
            <p>
              ...
              happier one so you don’t have to go through Monday Morning Blues.
            </p>
          </div>
        </div>
      </div>
