    ...
    <section className="article-section">
      <div className="container">
        ...
        <p className="description">
          ...
          partner with you and share your passion in creating comprehensive and
          meaningful digital experiences that are results-oriented.
        </p>
      </div>
    </section>
      ...
      <div className="container d-flex-space-center">
        ...
        <div className="key-expertise">
          ...
          <div className="card">
            <h4>Data Sciences</h4>
            <p>
              Develop systems that are intelligent and self-learning through the
      ...
      <div className="container">
        ...
        <div className="success-card-wrap d-flex">
          ...
          <div className="success-card">
            ...
            <p>
              We ensure architecture and user experience come together which is
              critical to build successful user adoptable products
            </p>
          </div>
          <div className="success-card">
            <svg
            ...
            <p>
              We employ technologies, frameworks, 3rd party components and cloud
              services to build secure and fast apps
            </p>
          </div>
          <div className="success-card">
            <svg
            ...
            <p>
              We employ agile development methodologies supported by DevOps and
              emerging techniques in code management
            </p>
          </div>
        </div>
      </div>
